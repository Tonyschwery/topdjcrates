...
function MyApp({ Component, pageProps }) {
  ...
  const [musicPacks, setMusicPacks] = useState([
      ...
      { id: 17, title: 'DANCEFLOOR WEAPONS', artist: 'Various Artists', description: 'The only crate you need to make people dance! Over 170+ selected WAV & MP3 tracks by our DJs.', cover: 'https://i.imgur.com/RI8Isa0.png', gumroadLink: 'https://payhip.com/b/DANCEFLOOR_WEAPONS_LINK', originalPrice: 30, discountedPrice: 20, tracks: [ { id: '17a', title: 'Dancefloor Weapons (short preview)', audioPreview: 'https://audio-hosting.netlify.app/preview danfloor weapons.mp3' } ] },
      { id: 18, title: 'Top Funky Edits', artist: 'Various Artists', description: 'Get the groove! 99+ handpicked funky edits, ready to play. Instantly elevate your set with high-quality WAV and MP3 tracks.', cover: 'https://i.imgur.com/iYnKp6o.png', gumroadLink: 'https://payhip.com/b/YOUR_LINK_HERE', demoLink: null, originalPrice: 25, discountedPrice: 20, tracks: [] },
      // --- NEW CRATES ADDED BELOW ---
      { 
        id: 19, 
