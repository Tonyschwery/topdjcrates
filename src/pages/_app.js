...
function MyApp({ Component, pageProps }) {
  ...
  const [musicPacks, setMusicPacks] = useState([
      ...
      { 
        ...
        gumroadLink: 'https://topdjcrates.gumroad.com/l/wmdgq', // Placeholder
        demoLink: null, // No demo link for now
        originalPrice: 30, 
        discountedPrice: 25, 
        tracks: [ { id: '18a', title: 'Top Funky Edits (short preview)', audioPreview: 'https://audio-hosting.netlify.app/preview funky edits.mp3' }
          // You can add preview tracks here later if you want
        ] 
      },
  ]);
  ...
  return (
    <>
      <Head>
        ...
        <noscript>
          <img height="1" width="1" style={{display: 'none'}} src="https://www.facebook.com/tr?id=1050992550450499&ev=PageView&noscript=1"/>
        </noscript>
      </Head>
